...
def main():
    ...
    display_note("'sep' (separator) and 'maxsplit' (maximum number of splits) and splits the string into a list of substrings", message_continue=True)
...
,
"Enter string is:" + string3 + "\n" +
"Splitting by default whitespace separator: " + str(string3.split()) + "\n" +
"Splitting by default whitespace separator with maxsplit=2: " + str(string3.split(maxsplit=2)) + "\n" +
"Splitting by '!' separator: " + str(string3.split(',')))
    ...
    display_note("If the separator is not found, ")
    display_note("it returns a tuple with the original string as the 1st element and two empty strings as the 2nd and 3rd elements.", message_continue=True)
...
''',
f"Joining list of strings {str_list} with space as delimiter: " + ' '.join(str_list) + "\n" + 
f"Joining list of strings {str_list} with comma as delimiter: " + ', '.join(str_list))
