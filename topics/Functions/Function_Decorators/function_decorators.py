...
def main(topic_number: int):
    print_heading("Decorators in Python", topic_number)
    
    imp_note_points("""
# **Decorator:**  
*A function that takes another function as an arg, adds some functionality to it without changing the original function's code, and then returns the enhanced function.*  
...
***The Outer Function:***  
- *This is the decorator itself. It takes one argument: the function to be decorated (func).* 
***The Inner "Wrapper" Function:*** 
- *Inside the decorator, you define another function (often called wrapper).*  
- *This is the function that contains the new functionality and also calls the original function.*  
- _To be able to decorate any function, this wrapper must accept *args and **kwargs._  
***The Return Statement:*** 
- *The outer decorator function returns the inner wrapper function.*  
