...
def main(topic_number: int):
    print_heading("OOP Relationship- Composition, Aggregation, and Association Demo", topic_number)
...
#--------------------------------------------------------------------------------#'''
    ...
    display_note("A strong form of aggregation where the contained class cannot exist independently of the containing class. If the containing class is destroyed, the contained class is also destroyed.")
